...
public final class PreviewDebugController {
	...
	public static void register() {
		KeyBindingHelper.registerKeyBinding(TOGGLE_PREVIEW_FIX_KEY);
		KeyBindingHelper.registerKeyBinding(TOGGLE_PREVIEW_DEBUG_KEY);
		KeyBindingHelper.registerKeyBinding(TOGGLE_PREVIEW_FORCE_KEY);
	...
	public static void logPreviewRenderContext(Screen screen, boolean focused) {
		...
		String context = "screen=" + screenName + ", focused=" + focused;
